      ...
      >
        ...
        >
          ...
          <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
            ...
            <!--begin::Action-->
            <a href="index-2.html" class="btn btn-primary">Try Katanya Temen</a>
            <!--end::Action-->
          </div>
          <!--end::Heading-->
      ...
      <div class="pb-15 pt-18 landing-dark-bg">
        ...
        <div class="container">
          ...
          <div class="fs-2 fw-semibold text-muted text-center mb-3">
            ...
            <br /><span class="text-gray-700 me-1">more powerful</span>,
          ...
          <div class="fs-2 fw-semibold text-muted text-center">
            <a href="account/security.html" class="link-primary fs-4 fw-bold"
              >Marcus Levy,</a
            >
        ...
        >
          ...
          <div class="my-2 me-5">
            ...
            <div class="fs-1 fs-lg-2qx fw-bold text-white mb-2">
              Start With Katanya Temen Today,
            ...
            <div class="col-lg-6 ps-lg-16">
              ...
              <div class="d-flex justify-content-center">
                ...
                <div class="d-flex fw-semibold flex-column me-20">
                  ...
                  <!--begin::Link-->
                  <a
                    href="https://preview.keenthemes.com/html/Katanya Temen/docs"
                    class="text-white opacity-50 text-hover-primary fs-5 mb-6"
                    >Documentaions</a
                  >
                  <!--end::Link-->
                  ...
                  <!--begin::Link-->
                  <a
                    href="https://preview.keenthemes.com/html/Katanya Temen/docs/getting-started/changelog"
                    class="text-white opacity-50 text-hover-primary fs-5 mb-6"
                    >Changelog</a
                  >
                  <!--end::Link-->
